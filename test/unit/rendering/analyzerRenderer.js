...
describe('AnalyzerRenderer: rendering/analyzerRenderer.js', function () {
    ...
    describe('Workflow', function () {
        ...
        var analyzerRenderer, parameters;
        ...
        it('Draw Strokes By RecognitionResult', function () {
            var strokes = [new MyScript.Stroke()],
        ...
        it('Draw Groups', function () {
            ...
            expect(function () {
                analyzerRenderer.drawGroups(strokes, groups, context, parameters);
        ...
        it('Draw Shapes Recognized', function () {
