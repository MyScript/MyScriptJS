...
describe('MathRenderer: rendering/mathRenderer.js', function () {
    ...
    describe('Workflow', function () {
        ...
        var mathRenderer, parameters, components, context;
        before(function (done) {
        ...
        it('Draw the recognition result', function () {
            var recognitionResult = new MyScript.MathDocument();
            mathRenderer.drawRecognitionResult(components, recognitionResult, context, parameters);
        });
