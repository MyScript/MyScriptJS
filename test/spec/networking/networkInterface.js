...
describe('MyScriptJS: input/networking/networkInterface.js', function () {
    ...
    it('NetworkInterface xhr', function () {
        ...
        networkInterface.xhr('POST', 'http://localhost:3001/api/v3.0/recognition/rest/shape/doSimpleRecognition.json', data).then(
    ...
    it('NetworkInterface get', function () {
        ...
        networkInterface.get('http://localhost:3001/api/v3.0/recognition/rest/text/languages.json', data).then(
            function success (response) {
    ...
    it('NetworkInterface post', function () {
        ...
        networkInterface.post('http://localhost:3001/api/v3.0/recognition/rest/shape/doSimpleRecognition.json', data).then(
            function success (response) {
                expect(response.instanceId).to.be.equal('117cd079-e816-4780-b533-fa7411df3b22');
            },
            function error (response) {
