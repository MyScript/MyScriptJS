...
export function createUndoRedoManager(from) {
  return clone({ stack: [], currentPosition: -1 }, from);
}

export function undo(undoRedoManager) {
  const newManager = clone({}, undoRedoManager);
