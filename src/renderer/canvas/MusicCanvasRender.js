...
(function (scope, logging) {
  ...
  scope.CanvasRender.prototype.drawMusicPrimitive = function (component) {
    ...
    switch (component.type) {
      ...
      case 'tieOrSlur':
      case 'timeSignature':
        _drawMusicNode(component, context, parameters);
        break;
  ...
  function _drawMusicNode(component, context, parameters) {
    switch (component.type) {
      case 'accidental':
        return _drawAccidental(component, context, parameters);
      case 'arpeggiate':
        return _drawArpeggiate(component, context, parameters);
      case 'bar':
        return _drawBar(component, context, parameters);
      case 'beam':
        return _drawBeam(component, context, parameters);
      case 'clef':
        return _drawClef(component, context, parameters);
      case 'decoration':
        return _drawDecoration(component, context, parameters);
      case 'dots':
        return _drawDots(component, context, parameters);
      case 'head':
        return _drawHead(component, context, parameters);
      case 'ledgerLine':
        return _drawLedgerLine(component, context, parameters);
      case 'rest':
        return _drawRest(component, context, parameters);
      case 'stem':
        return _drawStem(component, context, parameters);
      case 'tieOrSlur':
        return _drawTieOrSlur(component, context, parameters);
      case 'timeSignature':
        return _drawTimeSignature(component, context, parameters);
      default:
        throw new Error('MusicNode not implemented: ' + component.type);
    }
  }

  function _drawStaff(staff, context, parameters) {
...
//            var staves = Math.floor(context.canvas.clientHeight / staff.height);
  ...
  function _drawAccidental(accidental, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawArpeggiate(arpeggiate, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawBar(bar, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawBeam(beam, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawClef(clef, context, parameters) { // jshint ignore:line
  ...
  function _drawDecoration(decoration, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawDots(dots, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawHead(head, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawLedgerLine(ledgerLine, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawRest(rest, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawStem(stem, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawTieOrSlur(tieOrSlur, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _drawTimeSignature(timeSignature, context, parameters) { // jshint ignore:line
    throw new Error('not implemented');
  }

  function _removeMusicScratchOut(components, scratchOutResults) {
    ...
    for (var k in scratchOutResults) {
      if (scratchOutResults[k].erasedInputRanges) {
        for (var n in scratchOutResults[k].erasedInputRanges) {
          componentsToRemove.push(scratchOutResults[k].erasedInputRanges[n].component);
        }
        for (var p in scratchOutResults[k].inputRanges) {
