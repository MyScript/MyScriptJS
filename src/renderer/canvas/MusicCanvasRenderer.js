...
function drawClef(clef, context) { // jshint ignore:line
  ...
  switch (clef.value.symbol) {
    ...
    case 'G':
      ...
      break;
    default:
      throw new Error(`Unknown ${clef.value.symbol} music clef symbol`, clef);
  }
