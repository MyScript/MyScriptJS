(function (scope) {
    ...
    /**
     * The musicResourceUtils class is use to get a svg string for music symbols
     *
     * @class MusicResourceUtils
     * @static
     */
    function MusicResourceUtils () {
    }
     ...
     * @returns {String}
     */
    MusicResourceUtils.getClefSvg = function (clef) {
    ...
    // Export
    scope.MusicResourceUtils = MusicResourceUtils;
})(MyScript);