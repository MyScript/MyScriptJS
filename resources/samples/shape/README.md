...
### Create a [Renderer](http://myscript.github.io/MyScriptJS/api-reference/classes/ShapeRenderer.html)
...
### Create a [Recognizer](http://myscript.github.io/MyScriptJS/api-reference/classes/ShapeRecognizer.html)
...
To launch the recognition process, gather your input components and call the method [`doSimpleRecognition`](http://myscript.github.io/MyScriptJS/api-reference/classes/ShapeRecognizer.html#method_doSimpleRecognition).<br>
