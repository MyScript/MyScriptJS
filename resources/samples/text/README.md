...
For every recognition type, the result contains the `instanceId` and the recognition document, here a [TextDocument](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/TextDocument.html).
