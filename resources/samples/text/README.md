...
### Create a [Renderer](http://myscript.github.io/MyScriptJS/api-reference/classes/TextRenderer.html)
...
### Create a [InkManager](http://myscript.github.io/MyScriptJS/api-reference/InkManager.html)
...
### Create a [Recognizer](http://myscript.github.io/MyScriptJS/api-reference/classes/TextRecognizer.html)
...
To launch the recognition process, gather your input components and call the method [`doSimpleRecognition`](http://myscript.github.io/MyScriptJS/api-reference/classes/TextRecognizer.html#method_doSimpleRecognition).<br>
