...
### Create a [Renderer](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/TextRenderer.html)
...
### Create a [Recognizer](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/TextRecognizer.html)
...
To launch the recognition process, gather your input components and call the method [`doSimpleRecognition`](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/TextRecognizer.html#method_doSimpleRecognition).<br>
