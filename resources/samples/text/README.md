...
### Create a [Renderer](http://doc.myscript.com/MyScriptJS/1.0/reference/index.htmlclasses/TextRenderer.html)
...
### Create a [InkManager](http://doc.myscript.com/MyScriptJS/1.0/reference/index.htmlInkManager.html)
...
### Create a [Recognizer](http://doc.myscript.com/MyScriptJS/1.0/reference/index.htmlclasses/TextRecognizer.html)
...
To launch the recognition process, gather your input components and call the method [`doSimpleRecognition`](http://doc.myscript.com/MyScriptJS/1.0/reference/index.htmlclasses/TextRecognizer.html#method_doSimpleRecognition).<br>
