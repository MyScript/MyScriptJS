...
### Create a [Renderer](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/MusicRenderer.html)
...
### Create a [Recognizer](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/MusicRecognizer.html)
...
To launch the recognition process, gather your input components and call the method [`doSimpleRecognition`](http://doc.myscript.com/MyScriptJS/1.0/reference/classes/MusicRecognizer.html#method_doSimpleRecognition).<br>
